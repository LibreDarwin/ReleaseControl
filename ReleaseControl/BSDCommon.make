##
# BSDCommon.make - open-source Apple Release Control makefile
#
# Clean-room reimplementation of the interface provided by Apple's
# Core OS Makefiles "Release Control" BSDCommon.make.  Builds Apple
# style projects (tools, dylibs, static libraries) in RELEASE /
# DEBUG / PROFILE styles.  Preserves the public makefile API
# (variable names, targets, defaults) so that Darwin Core OS
# projects build unmodified.  Not affiliated with Apple.
#
